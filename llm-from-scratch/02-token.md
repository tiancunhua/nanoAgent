...
轮次 1: (e, s) 出现 9 次 → 合并为 "es"
轮次 2: (es, t) 出现 9 次 → 合并为 "est"
轮次 3: (l, o) 出现 7 次 → 合并为 "lo"
轮次 4: (lo, w) 出现 7 次 → 合并为 "low"
轮次 5: (n, e) 出现 6 次 → 合并为 "ne"
轮次 6: (ne, w) 出现 6 次 → 合并为 "new"
轮次 7: (new, est) 出现 6 次 → 合并为 "newest"
...
```
